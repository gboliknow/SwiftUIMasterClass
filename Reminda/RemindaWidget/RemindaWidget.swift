...
struct RemindaWidgetEntryView : View {
...
struct RemindaWidget: Widget {
    let kind: String = "RemindaWidget"

    var body: some WidgetConfiguration {
        StaticConfiguration(kind: kind, provider: Provider()) { entry in
            RemindaWidgetEntryView(entry: entry)
        }
...
struct RemindaWidget_Previews: PreviewProvider {
    static var previews: some View {
        Group {
            RemindaWidgetEntryView(entry: SimpleEntry(date: Date()))
